  ...
  return (
    <div className="flex-1 flex flex-col bg-[#0d0d0f]">
      ...
      <div className="flex bg-[#1a1a1f] border border-[#2e2e38] rounded-xl p-1 gap-1 mx-4 mb-4 flex-shrink-0">
        <button className="flex-1 py-1.5 text-[12px] font-semibold rounded-lg bg-[#2563eb] text-white border-none cursor-pointer">Left Earbud</button>
        <button onClick={() => onNavigate('earbud-right')} className="flex-1 py-1.5 text-[12px] font-semibold rounded-lg bg-transparent text-[#9ca3af] border-none cursor-pointer">Right Earbud</button>
      </div>
